...
| ------------ | :----: | -------------------------- | :---------: | -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ | -------------------------------------------------------------- | --------------------- |
| Hermes Agent |  ⭐⭐⭐⭐⭐ | Personal AI Agent          |      ✅      | Long running autonomous assistant with memory, tools, browser, messaging, scheduling and MCP support.    | [https://github.com/NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent)             | [https://hermes-agent.org](https://hermes-agent.org)           | OpenHands, Agent Zero |
...
| Paperclip    |  ⭐⭐⭐⭐☆ | AI Workspace               |      ✅      | Workspace for organizing AI agents and workflows.                                                        | [https://github.com/paperclipai/paperclip](https://github.com/paperclipai/paperclip)                   | —                                                              | OpenHands             |
...
| Claude Squad |  ⭐⭐⭐⭐☆ | Multi Agent   |      ✅      | Coordinate multiple Claude Code agents.                         | [https://github.com/smtg-ai/claude-squad](https://github.com/smtg-ai/claude-squad)   | —                                                      |
| HolyClaude   |  ⭐⭐⭐⭐☆ | Workspace     |      ✅      | Browser based Claude development environment.                   | [https://github.com/CoderLuii/HolyClaude](https://github.com/CoderLuii/HolyClaude)       | —                                                      |
| OpenSWE      |  ⭐⭐⭐⭐☆ | SWE Agent     |      ✅      | Autonomous software engineering framework.                      | [https://github.com/langchain-ai/open-swe](https://github.com/langchain-ai/open-swe)             | —                                                      |
| OPCODE       |  ⭐⭐⭐⭐☆ | Desktop       |      ✅      | Open source AI coding desktop app.                              | [https://github.com/winfunc/opcode](https://github.com/winfunc/opcode)                 | —                                                      |
| Blackbox AI  |  ⭐⭐⭐⭐☆ | IDE Extension |      ❌      | AI coding assistant with code search and generation.            | —     | [https://www.blackbox.ai](https://www.blackbox.ai)     |
...
| FreeFlow         |  ⭐⭐⭐⭐☆ | Voice Productivity    |      ✅      | Open source alternative to Wispr Flow for voice workflows.    | [https://github.com/zachlatta/freeflow](https://github.com/zachlatta/freeflow)                           | —                                              | Wispr Flow       |
| Paperclip        |  ⭐⭐⭐⭐☆ | AI Workspace          |      ✅      | Workspace for coordinating AI agents and projects.            | [https://github.com/paperclipai/paperclip](https://github.com/paperclipai/paperclip)                         | —                                              | OpenHands        |
...
| ------------------- | :----: | ------------------- | :---------: | ------------------------------------------------------ | -------------------------------------------------------------------------------------------------- | ------------ |
| codebase-memory-mcp |  ⭐⭐⭐⭐⭐ | MCP Server          |      ✅      | Gives coding agents persistent memory of repositories. | [https://github.com/DeusData/codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp) | Mem0         |
...
| Khoj (Second Brain) |  ⭐⭐⭐⭐☆ | Knowledge Base      |      ✅      | Self-hostable AI second brain with markdown and PDF support.                 | [https://github.com/khoj-ai/khoj](https://github.com/khoj-ai/khoj)               | Mem0         |
...
| FreeLLMAPI |  ⭐⭐⭐⭐☆ | Gateway              |      ✅      | Free OpenAI compatible API aggregation.                                           | [https://github.com/tashfeenahmed/freellmapi](https://github.com/tashfeenahmed/freellmapi) | —                                            |
...
| Tool                                      | Rating | Type              | Open Source | Description                                                                       | GitHub                                                                                                                                       | Website                                            | Alternatives |
| ----------------------------------------- | :----: | ----------------- | :---------: | --------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- | ------------ |
| OpenMontage                               |  ⭐⭐⭐⭐⭐ | Video Production  |      ✅      | Agentic video production pipeline with editing, scripting and automation.         | [https://github.com/calesthio/OpenMontage](https://github.com/calesthio/OpenMontage)                                                           | —                                                  | ComfyUI      |
...
| Wan2GP                                    |  ⭐⭐⭐⭐☆ | Video Toolkit     |      ✅      | Utilities for running and optimizing Wan models.                                  | [https://github.com/deepbeepmeep/Wan2GP](https://github.com/deepbeepmeep/Wan2GP)                                                                     | —                                                  | ComfyUI      |
| Higgsfield AI CLI                         |  ⭐⭐⭐⭐☆ | Video Generation  |      ✅      | Official CLI for generating videos and managing models.                                | [https://github.com/higgsfield-ai/cli](https://github.com/higgsfield-ai/cli)                                                   | —                                                  | LTX Video    |
...
| Tool                    | Rating | Type               | Open Source | Description                                                                | GitHub                                                                                             | Website                                          | Alternatives  |
| ----------------------- | :----: | ------------------ | :---------: | -------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | ------------------------------------------------ | ------------- |
| OpenAlice               |  ⭐⭐⭐⭐⭐ | Trading Workspace  |      ✅      | File-driven "Trading-as-Git" autonomous engine and workspace.              | [https://github.com/TraderAlice/OpenAlice](https://github.com/TraderAlice/OpenAlice)               | [https://openalice.ai](https://openalice.ai)                     | —             |
...
| Fincept Terminal        |  ⭐⭐⭐⭐☆ | Finance Platform   |      ✅      | AI powered financial research terminal.                                    | [https://github.com/Fincept-Corporation/FinceptTerminal](https://github.com/Fincept-Corporation/FinceptTerminal)                         | —                                                | BloombergGPT  |
