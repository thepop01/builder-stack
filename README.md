...
| Tool         | Rating | Type                       | Open Source | Description                                                                                              | GitHub                                                                                           | Website                                                        | Alternatives          |
| ------------ | :----: | -------------------------- | :---------: | -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ | -------------------------------------------------------------- | --------------------- |
| Hermes Agent |  ⭐⭐⭐⭐⭐ | Personal AI Agent          |      ✅      | Long running autonomous assistant with memory, tools, browser, messaging, scheduling and MCP support.    | [https://github.com/search?q=hermes-agent](https://github.com/search?q=hermes-agent)             | [https://hermes-agent.org](https://hermes-agent.org)           | OpenHands, Agent Zero |
| OpenClaw     |  ⭐⭐⭐⭐⭐ | Personal AI Agent          |      ✅      | Persistent self-hosted background daemon agent that runs 24/7.                           | [https://github.com/openclaw/openclaw](https://github.com/openclaw/openclaw)                 | [https://openclaw.ai](https://openclaw.ai)                     | Hermes                |
| OpenHands    |  ⭐⭐⭐⭐⭐ | Software Engineering Agent |      ✅      | One of the strongest autonomous software engineering agents. Can browse, code, run tests and fix issues. | [https://github.com/OpenHands/OpenHands](https://github.com/OpenHands/OpenHands)                 | [https://www.all-hands.dev](https://www.all-hands.dev)         | Claude Code           |
| Agent Zero   |  ⭐⭐⭐⭐☆ | Autonomous Agent           |      ✅      | General purpose autonomous AI agent with browser and tool support.                                       | [https://github.com/frdel/agent-zero](https://github.com/frdel/agent-zero)                       | —                                                              | Hermes                |
| Atomic Agent |  ⭐⭐⭐⭐☆ | Local Agent                |      ✅      | Runs locally with browser control, terminal, memory and tool execution.                                  | [https://github.com/BrainBlend-AI/atomic-agents](https://github.com/BrainBlend-AI/atomic-agents) | —                                                              | Hermes                |
| Goose        |  ⭐⭐⭐⭐☆ | Desktop Agent              |      ✅      | Open source desktop AI agent from Block with strong MCP integration.                                     | [https://github.com/block/goose](https://github.com/block/goose)                                 | [https://block.github.io/goose](https://block.github.io/goose) | OpenHands             |
| OpenAlice    |  ⭐⭐⭐⭐☆ | Desktop Assistant          |      ✅      | Personal desktop AI assistant.                                                                           | [https://github.com/openalice](https://github.com/openalice)                                     | —                                                              | Hermes                |
| MultitaskAI  |  ⭐⭐⭐⭐☆ | Agent Platform             |      ❌      | Team of AI agents working together on multiple tasks.                                                    | —                                                                                                | [https://multitaskai.com](https://multitaskai.com)             | CrewAI                |
| Paperclip    |  ⭐⭐⭐⭐☆ | AI Workspace               |      ✅      | Workspace for organizing AI agents and workflows.                                                        | [https://github.com/search?q=paperclip](https://github.com/search?q=paperclip)                   | —                                                              | OpenHands             |

---

# 💻 Coding Agents

| Tool         | Rating | Type          | Open Source | Description                                                     | GitHub                                                                                 | Website                                                |
| ------------ | :----: | ------------- | :---------: | --------------------------------------------------------------- | -------------------------------------------------------------------------------------- | ------------------------------------------------------ |
| Claude Code  |  ⭐⭐⭐⭐⭐ | CLI           |      ❌      | Still one of the strongest coding agents available.             | [https://github.com/anthropics/claude-code](https://github.com/anthropics/claude-code) | [https://www.anthropic.com](https://www.anthropic.com) |
| OpenCode     |  ⭐⭐⭐⭐⭐ | CLI           |      ✅      | Fast open source coding agent supporting many providers.        | [https://github.com/sst/opencode](https://github.com/sst/opencode)                     | [https://opencode.ai](https://opencode.ai)             |
| jcode        |  ⭐⭐⭐⭐⭐ | CLI/Desktop   |      ✅      | Coding agent with persistent memory, subagents and MCP support. | [https://github.com/jcode-ai](https://github.com/jcode-ai)                             | [https://jcode.sh](https://jcode.sh)                   |
| Aider        |  ⭐⭐⭐⭐⭐ | CLI           |      ✅      | Git aware AI pair programmer.                                   | [https://github.com/Aider-AI/aider](https://github.com/Aider-AI/aider)                 | [https://aider.chat](https://aider.chat)               |
| Continue     |  ⭐⭐⭐⭐☆ | IDE           |      ✅      | VS Code and JetBrains AI coding extension.                      | [https://github.com/continuedev/continue](https://github.com/continuedev/continue)     | [https://continue.dev](https://continue.dev)           |
| Cline        |  ⭐⭐⭐⭐☆ | VS Code       |      ✅      | Autonomous coding agent inside VS Code.                         | [https://github.com/cline/cline](https://github.com/cline/cline)                       | [https://cline.bot](https://cline.bot)                 |
| SuperClaude  |  ⭐⭐⭐⭐☆ | Claude Skills |      ✅      | Advanced prompts and workflows for Claude Code.                 | [https://github.com/NomenAK/SuperClaude](https://github.com/NomenAK/SuperClaude)       | —                                                      |
| Claude Squad |  ⭐⭐⭐⭐☆ | Multi Agent   |      ✅      | Coordinate multiple Claude Code agents.                         | [https://github.com/search?q=claude+squad](https://github.com/search?q=claude+squad)   | —                                                      |
| HolyClaude   |  ⭐⭐⭐⭐☆ | Workspace     |      ✅      | Browser based Claude development environment.                   | [https://github.com/search?q=holyclaude](https://github.com/search?q=holyclaude)       | —                                                      |
| OpenSWE      |  ⭐⭐⭐⭐☆ | SWE Agent     |      ✅      | Autonomous software engineering framework.                      | [https://github.com/search?q=openswe](https://github.com/search?q=openswe)             | —                                                      |
| OPCODE       |  ⭐⭐⭐⭐☆ | Desktop       |      ✅      | Open source AI coding desktop app.                              | [https://github.com/winfunc/opcode](https://github.com/winfunc/opcode)                 | —                                                      |
| Blackbox AI  |  ⭐⭐⭐⭐☆ | IDE Extension |      ❌      | AI coding assistant with code search and generation.            | [https://github.com/search?q=blackbox+ai](https://github.com/search?q=blackbox+ai)     | [https://www.blackbox.ai](https://www.blackbox.ai)     |

---

# 🔬 Research

| Tool           | Rating | Type              | Open Source | Description                                                        |
| -------------- | :----: | ----------------- | :---------: | ------------------------------------------------------------------ |
...
| Tool             | Rating | Type                  | Open Source | Description                                                   | GitHub                                                                                                 | Website                                        | Alternatives     |
| ---------------- | :----: | --------------------- | :---------: | ------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | ---------------------------------------------- | ---------------- |
| Flowise          |  ⭐⭐⭐⭐⭐ | Workflow Builder      |      ✅      | Drag and drop builder for LLMs, RAG pipelines, and AI agents. | [https://github.com/FlowiseAI/Flowise](https://github.com/FlowiseAI/Flowise)                           | [https://flowiseai.com](https://flowiseai.com) | Langflow, n8n    |
| Loop Engineering |  ⭐⭐⭐⭐☆ | Engineering Framework |      ✅      | Framework for planning and iterative AI software engineering. | [https://github.com/cobusgreyling/loop-engineering](https://github.com/cobusgreyling/loop-engineering) | —                                              | Spec Kit         |
| Spec Kit         |  ⭐⭐⭐⭐☆ | Development Framework |      ✅      | Specification first software development with AI.             | [https://github.com/github/spec-kit](https://github.com/github/spec-kit)                               | —                                              | Loop Engineering |
| FreeFlow         |  ⭐⭐⭐⭐☆ | Voice Productivity    |      ✅      | Open source alternative to Wispr Flow for voice workflows.    | [https://github.com/search?q=freeflow](https://github.com/search?q=freeflow)                           | —                                              | Wispr Flow       |
| Paperclip        |  ⭐⭐⭐⭐☆ | AI Workspace          |      ✅      | Workspace for coordinating AI agents and projects.            | [https://github.com/search?q=paperclip](https://github.com/search?q=paperclip)                         | —                                              | OpenHands        |
| Agency Agents    |  ⭐⭐⭐⭐☆ | Multi Agent           |      ✅      | AI agency framework with specialized agents.                  | [https://github.com/msitarzewski/agency-agents](https://github.com/msitarzewski/agency-agents)         | —                                              | CrewAI           |

---

# 🧠 MCP & Memory

| Tool                | Rating | Type                | Open Source | Description                                            | GitHub                                                                                             | Alternatives |
| ------------------- | :----: | ------------------- | :---------: | ------------------------------------------------------ | -------------------------------------------------------------------------------------------------- | ------------ |
| codebase-memory-mcp |  ⭐⭐⭐⭐⭐ | MCP Server          |      ✅      | Gives coding agents persistent memory of repositories. | [https://github.com/search?q=codebase-memory-mcp](https://github.com/search?q=codebase-memory-mcp) | Mem0         |
| Open Data Platform  |  ⭐⭐⭐⭐☆ | MCP Platform        |      ✅      | Data platform exposing information through MCP.        | (various implementations)                                                                          | LlamaIndex   |
| Headroom            |  ⭐⭐⭐⭐☆ | Context Compression |      ✅      | Compresses long contexts to reduce token usage.        | [https://github.com/search?q=headroom](https://github.com/search?q=headroom)                       | LLMLingua    |
| Second Brain        |  ⭐⭐⭐⭐☆ | Knowledge Base      |      ✅      | Long term knowledge and memory for AI.                 | [https://github.com/search?q=second+brain](https://github.com/search?q=second+brain)               | Mem0         |
...
| Tool       | Rating | Type                 | Open Source | Description                                                                       | GitHub                                                                           | Website                                      |
| ---------- | :----: | -------------------- | :---------: | --------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | -------------------------------------------- |
| OmniRoute  |  ⭐⭐⭐⭐⭐ | AI Gateway           |      ✅      | Self-hosted proxy with 200+ providers, 4-tier fallback, and token compression. | [https://github.com/omniroute/omniroute](https://github.com/omniroute/omniroute)                                                                               | [https://omniroute.ai](https://omniroute.ai) |
| MuAPI      |  ⭐⭐⭐⭐☆ | AI Gateway           |      ❌      | Unified API for multiple AI models.                                               | —                                                                                | —                                            |
| Godmode3   |  ⭐⭐⭐⭐☆ | Multi Model Platform |      ❌      | Unified interface for dozens of AI models.                                        | —                                                                                | [https://godmode3.ai](https://godmode3.ai)   |
| FreeLLMAPI |  ⭐⭐⭐⭐☆ | Gateway              |      ✅      | Free OpenAI compatible API aggregation.                                           | [https://github.com/search?q=freellmapi](https://github.com/search?q=freellmapi) | —                                            |
| 9Router    |  ⭐⭐⭐⭐☆ | AI Router            |      ❌      | Model routing and optimization platform.                                          | —                                                                                | —                                            |
| Nango      |  ⭐⭐⭐⭐⭐ | Integration Platform |      ✅      | OAuth and API integration layer with hundreds of connectors.                      | [https://github.com/NangoHQ/nango](https://github.com/NangoHQ/nango)             | [https://nango.dev](https://nango.dev)       |
...
| Tool                                      | Rating | Type              | Open Source | Description                                                                       | GitHub                                                                                                                                       | Website                                            | Alternatives |
| ----------------------------------------- | :----: | ----------------- | :---------: | --------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- | ------------ |
| OpenMontage                               |  ⭐⭐⭐⭐⭐ | Video Production  |      ✅      | Agentic video production pipeline with editing, scripting and automation.         | [https://github.com/search?q=openmontage](https://github.com/search?q=openmontage)                                                           | —                                                  | ComfyUI      |
| LTX Video 2                               |  ⭐⭐⭐⭐⭐ | Video Model       |      ✅      | High quality open video generation model.                                         | [https://github.com/Lightricks/LTX-Video](https://github.com/Lightricks/LTX-Video)                                                           | [https://ltx.studio](https://ltx.studio)           | Wan 2.2      |
| Deevis AI                                 |  ⭐⭐⭐⭐☆ | Video Generation  |      ❌      | AI video generation platform.                                                     | —                                                                                                                                            | [https://deevis.ai](https://deevis.ai)             | Kling        |
| Wan2GP                                    |  ⭐⭐⭐⭐☆ | Video Toolkit     |      ✅      | Utilities for running and optimizing Wan models.                                  | [https://github.com/search?q=wan2gp](https://github.com/search?q=wan2gp)                                                                     | —                                                  | ComfyUI      |
| Open Higgsfield AI                        |  ⭐⭐⭐⭐☆ | Video Generation  |      ✅      | Open source alternative inspired by Higgsfield AI.                                | [https://github.com/search?q=open+higgsfield](https://github.com/search?q=open+higgsfield)                                                   | —                                                  | LTX Video    |
| OpenArt AI                                |  ⭐⭐⭐⭐☆ | AI Creative Suite |      ❌      | AI image and video generation platform.                                           | —                                                                                                                                            | [https://openart.ai](https://openart.ai)           | Leonardo AI  |
| KlipRok                                   |  ⭐⭐⭐⭐☆ | Video Editing     |      ❌      | Converts long videos into Shorts, Reels and TikToks with captions and scheduling. | —                                                                                                                                            | [https://www.kliprok.com](https://www.kliprok.com) | OpusClip     |
| Lyro Studio                               |  ⭐⭐⭐⭐☆ | Video Editor      |      ❌      | AI assisted video editing platform.                                               | —                                                                                                                                            | —                                                  | CapCut AI    |
| Video2OpenShotCraft                       |  ⭐⭐⭐⭐☆ | Animation         |      ✅      | Converts prompts into OpenShot compatible animations.                             | [https://github.com/search?q=video2openshotcraft](https://github.com/search?q=video2openshotcraft)                                           | —                                                  | OpenMontage  |
| Gorest 2D Animation Spritesheet Generator |  ⭐⭐⭐⭐☆ | Game Dev          |      ✅      | Generates 2D animation spritesheets using AI.                                     | [https://github.com/NO6KIKO/gorest-2d-animation-spritesheet-generator](https://github.com/NO6KIKO/gorest-2d-animation-spritesheet-generator) | —                                                  | PixelLab     |
...
| Tool        | Rating | Type               | Open Source | Description                              | Alternatives |
| ----------- | :----: | ------------------ | :---------: | ---------------------------------------- | ------------ |
...
| Tool                    | Rating | Type               | Open Source | Description                                                                | GitHub                                                                                             | Website                                          | Alternatives  |
| ----------------------- | :----: | ------------------ | :---------: | -------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | ------------------------------------------------ | ------------- |
| TradingAgents           |  ⭐⭐⭐⭐⭐ | Multi Agent        |      ✅      | Multi agent LLM framework for stock and crypto trading.                    | [https://github.com/TauricResearch/TradingAgents](https://github.com/TauricResearch/TradingAgents) | —                                                | FinRobot      |
| TensorTrade             |  ⭐⭐⭐⭐☆ | RL Framework       |      ✅      | Reinforcement learning framework for algorithmic trading.                  | [https://github.com/tensortrade-org/tensortrade](https://github.com/tensortrade-org/tensortrade)   | —                                                | FinRL         |
| QuantMind               |  ⭐⭐⭐⭐☆ | Knowledge Graph    |      ✅      | Turns financial reports, SEC filings and papers into searchable knowledge. | —                                                                                                  | —                                                | LlamaIndex    |
| Fincept Terminal        |  ⭐⭐⭐⭐☆ | Finance Platform   |      ✅      | AI powered financial research terminal.                                    | [https://github.com/search?q=fincept](https://github.com/search?q=fincept)                         | —                                                | BloombergGPT  |
...
| Polymarket Data         |  ⭐⭐⭐⭐☆ | SDK                |      ✅      | APIs and analytics for Polymarket.                                         | —                                                                                                  | [https://polymarket.com](https://polymarket.com) | Cloudds       |
...
| Project                | Rating | Type              | Why it matters                                    |
| ---------------------- | :----: | ----------------- | ------------------------------------------------- |
...
| Project      | Rating | Why it stands out                                 |
| ------------ | :----: | ------------------------------------------------- |
